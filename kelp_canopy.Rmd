...
canopy_area_tall # search within year and regionto find max
...
canopy_area_joined <- left_join(canopy_area_tall, canopy_area_tall_max)

ggplot(canopy_area_joined, aes(x = year, y = max.annual)) +
  #BOOKMARK!!
